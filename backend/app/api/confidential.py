    ...
    return [
        {
            ...
            "locked_until": f.confidential_meta.locked_until.strftime("%Y-%m-%dT%H:%M:%SZ") if (f.confidential_meta and f.confidential_meta.locked_until) else None,
            "locked_until_ist": to_ist(f.confidential_meta.locked_until) if (f.confidential_meta and f.confidential_meta.locked_until) else None,
